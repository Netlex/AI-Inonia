...
async def send_post_request(
    ...
    try:
        ...
        if r.ok is False:
            try:
                ...
                raise HTTPException(
                    ...
                    detail=f"AI Inonia: Server Connection Error",
                )
        ...
        raise HTTPException(
            ...
            detail=detail if e else "AI Inonia: Server Connection Error",
        )
...
async def verify_connection(
    ...
    async with aiohttp.ClientSession(
        ...
        try:
            ...
            raise HTTPException(
                status_code=500, detail="AI Inonia: Server Connection Error"
            )
        except Exception as e:
...
async def get_openai_models(
    ...
    if url_idx is None:
        ...
        try:
            ...
            log.exception(e)
            error_detail = "AI Inonia: Server Connection Error"
            if r is not None:
                try:
                    res = r.json()
                    if "error" in res:
